...
public class SellerFormController implements Initializable{
	...
	private Seller getFormData() {
		...
		if(txtEmail.getText() == null || txtEmail.getText().trim().equals("")) { // exception to empty fields
		...
		if(txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) { // exception to empty fields
