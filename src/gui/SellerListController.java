...
public class SellerListController implements Initializable, DataChangeListener {
	...
	public void setSellerService(SellerService service) { // dependecy inject
	...
	private void initializeNodes() {
		...
		tableViewSeller.prefHeightProperty().bind(stage.heightProperty()); // table follow this window height config
	...
	public void updateTableView() {
		...
		List<Seller> list = service.findAll(); // return list of SellerService
		obsList = FXCollections.observableArrayList(list); // instance obsList with data and reference to list
		tableViewSeller.setItems(obsList); // load itens in tableView
